...
class Player extends React.Component<IProps, IState> {
  ...
  public componentDidUpdate(prevProps: IProps) {
    if (this.props.audioGsUrl !== prevProps.audioGsUrl) {
      this.fetchAudioUrl()
  ...
  public render() {
    ...
    return (
      <div>
        <audio ref={this.audioRef} src={this.state.audioUrl} />
        <div id="player">
  ...
  private async fetchAudioUrl() {
    try {
      const audioUrl = await storage.refFromURL(this.props.audioGsUrl).getDownloadURL()
